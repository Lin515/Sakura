...
<div class="post-entry">
  <div class="feature">
	<?php if ( has_post_thumbnail() ) { ?>
		...
		<?php } else {?>
		<a href="<?php the_permalink();?>"><div class="overlay"><i class="iconfont icon-text"></i></div><img src="<?php static_link_e(); ?>/img/Sakura/images/random/m-<?php echo rand(1,6)?>.jpg" /></a>
		<?php } ?>
	</div>
