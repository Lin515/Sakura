            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="/wp-content/themes/Sakura/cdn-moezx/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                        lazyload();
...
function coverVideoIni() {
    if ($('video').hasClass('hls')) {
        if (mashiro_global.variables.has_hls){
            ...
            $.getScript("/wp-content/themes/Sakura/cdn-moezx/js/src/16.hls.js", function(){
                loadHls();
...
loadCSS("/wp-content/themes/Sakura/cdn/APlayer/dist/APlayer.min.css");
